...
public class GBWHttpLogFileServerHandler extends SimpleChannelInboundHandler<FullHttpRequest> {
    ...
    public GBWHttpLogFileServerHandler(String url, String downloadDir) {
        this.url = url;
